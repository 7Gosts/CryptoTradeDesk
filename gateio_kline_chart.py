...
依赖: pip install -r CryptoTradeDesk/requirements.txt

示例:
  python3 CryptoTradeDesk/gateio_kline_chart.py --market-brief
  python3 CryptoTradeDesk/gateio_kline_chart.py --market-brief --with-charts
  python3 CryptoTradeDesk/gateio_kline_chart.py --pair ETH_USDT
  python3 CryptoTradeDesk/gateio_kline_chart.py --pair ETH_USDT --chart-only
  python3 CryptoTradeDesk/gateio_kline_chart.py --pair ETH_USDT --report-only
  python3 CryptoTradeDesk/gateio_kline_chart.py --pair ETH_USDT --single-timeframe --interval 4h --limit 120
"""
...
from CryptoTradeDesk.kline_analysis import (
    MA_LONG,
    MA_MID,
    MA_SHORT,
    MIN_JOURNAL_RR,
...
from CryptoTradeDesk.tools.time_utils import fmt_from_iso, fmt_local, parse_iso_utc
